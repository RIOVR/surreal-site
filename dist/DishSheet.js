...
const DishSheet = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(PlaceholderBig, {
    glyph: isDrink ? '◉' : '✦',
    accent: accent
  })), /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    color: isDrink ? 'magenta' : 'ember'
  }, item.tag), item.base && /*#__PURE__*/React.createElement(Tag, {
    color: "ember"
  }, item.base), item.ml && /*#__PURE__*/React.createElement("span", {
    style: {
  ...
  }, item.ml, "ML"))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '36px 34px',
      overflow: 'auto',
      display: 'flex',
    ...
    color: isDrink ? 'magenta' : 'red'
  }, isDrink ? 'Drink' : item.tipo || 'Cardápio'), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
  ...
  }, item.desc), item.poema && item.poema.length > 0 && /*#__PURE__*/React.createElement("blockquote", {
    style: {
  ...
  }, item.poema.map((l, i) => /*#__PURE__*/React.createElement("div", {
    key: i
  }, l))), item.alerg && item.alerg.length > 0 && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Eyebrow, {
    color: "muted",
    size: "xs"
  }, "pode conter"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      gap: 8,
  ...
  }, item.alerg.map(a => /*#__PURE__*/React.createElement("span", {
    key: a,
    style: {
      fontFamily: 'var(--font-body)',
      fontSize: 11,
